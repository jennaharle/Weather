const api_key = '4a05f0eafd10ec6592061db42525e3a9';
const icon_url = 'http://api.openweathermap.org/img/wn/';
const url = 'https://api.openweathermap.org/data/2.5/weather?';
const iconFileExtension = '@2x.png'
...
const getWeather = (lat, lng) => {
    ...
    axios.get(address)
      .then(response => {
        ...
        const image = icon_url + json.weather[0].icon + iconFileExtension;
        icon_img.src = image;
      })
      .catch(error => {
        alert(error);
